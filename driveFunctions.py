...
def main_drive(args:list):
    ...
    code = 0
    try:
        save_option, choice, parent, pid, filetype, mime_option, numfiles, meta_id, logloc = process_input_parameters(args)
